# blocksworld-script
Python scripts for generating and organizing Blocksworld datasets for AI benchmarking, including difficulty levels and solution steps from initial states to goal states.
import heapq
import itertools
import random
import os
